...
const ProjectFormPage: React.FC = () => {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 720, margin: '0 auto' }}>
      <Typography.Title level={4}>创建新项目</Typography.Title>
      ...
      <Card>
        <Form form={form} layout="vertical">
          ...
          {current === 3 && (
            <div style={{ textAlign: 'center', padding: 20 }}>
              <Typography.Title level={5}>准备提交</Typography.Title>
              <Typography.Text type="secondary">请检查信息后点击提交创建项目。</Typography.Text>
            </div>
          )}
        </Form>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 24 }}>
          ...
          <Space>
            ...
            {current === steps.length - 1 && <Button type="primary" onClick={handleSubmit} loading={submitting}>提交</Button>}
          </Space>
        </div>
      </Card>
    </div>
