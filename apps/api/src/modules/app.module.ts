...
import { asinOpportunityModule } from './asin-opportunities/index.js';
import { savedViewsModule } from './saved-views/index.js';

export const AppModule = {
  modules: [authModule, usersModule, ledgerModule, reconciliationModule, productDevModule, asinOpportunityModule, savedViewsModule],
};
